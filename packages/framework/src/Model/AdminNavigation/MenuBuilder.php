...
class MenuBuilder
{
    ...
    public function createMainMenu(): ItemInterface
    {
        ...
        $this->dispatchConfigureMenuEvent(ConfigureMenuEvent::CONFIGURE_ROOT, $menu);
    ...
    protected function createDashboardMenu(): ItemInterface
    {
        ...
        $this->dispatchConfigureMenuEvent(ConfigureMenuEvent::CONFIGURE_DASHBOARD, $menu);
    ...
    protected function createOrdersMenu(): ItemInterface
    {
        ...
        $this->dispatchConfigureMenuEvent(ConfigureMenuEvent::CONFIGURE_ORDERS, $menu);
    ...
    protected function createCustomersMenu(): ItemInterface
    {
        ...
        $this->dispatchConfigureMenuEvent(ConfigureMenuEvent::CONFIGURE_CUSTOMERS, $menu);
    ...
    protected function createProductsMenu(): ItemInterface
    {
        ...
        $this->dispatchConfigureMenuEvent(ConfigureMenuEvent::CONFIGURE_PRODUCTS, $menu);
    ...
    protected function createPricingMenu(): ItemInterface
    {
        ...
        $this->dispatchConfigureMenuEvent(ConfigureMenuEvent::CONFIGURE_PRICING, $menu);
    ...
    protected function createMarketingMenu(): ItemInterface
    {
        ...
        $this->dispatchConfigureMenuEvent(ConfigureMenuEvent::CONFIGURE_MARKETING, $menu);
    ...
    protected function createAdministratorsMenu(): ItemInterface
    {
        ...
        $this->dispatchConfigureMenuEvent(ConfigureMenuEvent::CONFIGURE_ADMINISTRATORS, $menu);
    ...
    protected function createSettingsMenu(): ItemInterface
    {
        ...
        if ($this->authorizationChecker->isGranted(Roles::ROLE_SUPER_ADMIN)) {
            ...
            $superadminMenu->setAttribute('class', 'dangerous');
            $superadminMenu->setChildrenAttribute('class', 'dangerous');
        ...
        $this->dispatchConfigureMenuEvent(ConfigureMenuEvent::CONFIGURE_SETTINGS, $menu);
